    ...
    <div className="grid-container">
      <div className="grid-container1">
        <div className="grid-item item-1">
          <h1 className="product1">{props.title}</h1>
          <img src={require("./Image1.png")} alt="Image1" />
        </div>
        <div className="grid-item item-2">
          <h1 className="product2">
            SHOP THORNE<br></br> NUTRITION
          </h1>
          <img src={require("./Image3.png")} alt="Image3" />
        </div>
        <div className="grid-item item-3">
          <h1 className="product3">
            WHAT<br></br>PROBIOTICS<br></br>CAN DO<br></br>FOR YOU <hr />
          </h1>
          <img src={require("./Image2.png")} alt="Image2" />
          {/* <a href="#">READ+SHOP</a> */}
        </div>
        <div className="grid-item item-4">
          <h2 className="product4">
            EXPLORE NUTRITION <br></br>COMMUNITY
          </h2>
          <img src={require("./Image4.png")} alt="Image4" />
          {/* <a href="#">VIEW COMMUNITY </a> */}
        </div>
        <div className="grid-item item-5">
          <h3 className="product5">
            HOW SOON <br></br>AFTER YOU<br></br>EAT<br></br>SHOULD YOU<br></br>
            GO TO SLEEP?
          </h3>
        ...
        <div className="grid-item item-6">
          <h2 className="product6">
            WHICH<br></br>MACROS<br></br>IS RIGHT<br></br>FOR ME?
          </h2>
      ...
      <div className="grid-container2">
        <div className="grid-item item-7">
          <h6 className="product7">
            Theragun Pro<br></br>$449.99
          </h6>
          <img src={require("./Image7.jpg")} alt="Image7" />
        </div>
        <div className="grid-item item-8">
          <h6 className="product8">
            Therabody PowerDot 2.0<br></br>$399.99
          </h6>
          <img src={require("./Image7.jpg")} alt="Image7" />
        </div>
        <div className="grid-item item-9">
          <h6 className="product9">
            Roll Recovery R8<br></br>$129.00
          </h6>
          <img src={require("./Image7.jpg")} alt="Image7" />
        </div>
        <div className="grid-item item-10">
          <h6 className="product10">
            Smart Tools SmartCuffs<br></br>$299.99
          </h6>
          <img src={require("./Image7.jpg")} alt="Image7" />
        </div>
      </div>
